...
public class Curso implements Serializable {
     ...
     private List<Asignacion> asiganciones;
     ...
     public List<Asignacion> getAsiganciones() {
          return asiganciones;
     }

     public void setAsiganciones(List<Asignacion> asiganciones) {
          this.asiganciones = asiganciones;
     }
